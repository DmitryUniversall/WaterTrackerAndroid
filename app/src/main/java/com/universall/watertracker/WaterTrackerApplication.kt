...
class WaterTrackerApplication : Application() {
    ...
    private fun launchNotificationsWork() {
        ...
        NotificationsHelperImplST.get().createChannel()

        NotificationsSchedulerImplST.init(this, SettingsServiceImplST.get(), NotificationsHelperImplST.get())
        NotificationsSchedulerImplST.get().launch()
    }
}
